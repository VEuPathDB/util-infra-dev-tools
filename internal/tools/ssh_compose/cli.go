...
const usage = "Generates a docker-compose configuration file and required " +
	...
	"If an `.env` file already exists in this project, it will be updated to add" +
	"any missing environment variables required by the generated docker compose" +
	"file.  If no `.env` file yet exists in this project, a new one will be" +
	"generated.  See the docker compose docs for `.env` files for more info.\n\n" +
